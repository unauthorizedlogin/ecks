...
The interface is responsible for presentation and player interaction only. Quest progression, validation, visibility, tracking state, completion, and cancellation remain owned by the Quest System.
