...
For details on the localization architecture, translation workflow, and CSV → PO generator, see the [Localization](./docs/system/engine/localization.md) and [PO Generator](./docs/data/generators/po_generator.md) documentation.
